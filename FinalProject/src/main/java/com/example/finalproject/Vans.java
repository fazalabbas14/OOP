...
public class Vans {
    ...
    public Scene getScene(Stage Stage) {
        ...
        Text category_title=new Text("Available Vans");
        ...
        Image carbutton_image=new Image(getClass().getResource("/van-logo.png").toExternalForm());
        ...
        Image bikebutton_image=new Image(getClass().getResource("/van-logo.png").toExternalForm());
        ...
        Button signup_3=new Button("Toyota Alfard\nModel: 2025 Rent: $60/day",vanbutton_imgview);
