...
public class Bikes {
    ...
    public Scene getScene(Stage Stage) {
        ...
        Text category_title=new Text("Available Bikes");
        ...
        Image carbutton_image=new Image(getClass().getResource("/bike-logo.png").toExternalForm());
        ...
        Image vanbutton_image=new Image(getClass().getResource("/bike-logo.png").toExternalForm());
